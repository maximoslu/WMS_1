...
<nav class="navbar navbar-expand-lg navbar-dark navbar-custom shadow-lg sticky-top">
    <div class="container-fluid px-4">
        <a class="navbar-brand d-flex align-items-center" href="dashboard.php">
            ...
            <span>MAXIMO<span class="text-primary">WMS</span></span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarMain">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark shadow">
                        ...
                        <li><a class="dropdown-item" href="almacen_consulta.php"><i class="bi bi-search me-2"></i>Consulta</a></li>
                ...
                <!-- Artículo (Oculto para cliente_admin según lógica previa o restringido) -->
                <?php if (!$isClienteAdmin): ?>
                <li class="nav-item">
                    <a class="nav-link" href="articulos.php"><i class="bi bi-box-seam me-1"></i> Artículo</a>
                </li>
                <?php endif; ?>
            ...
            <div class="d-flex align-items-center">
                <div class="text-light me-3 d-none d-md-block text-end">
